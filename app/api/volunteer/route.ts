  ...
  try {
    ...
    try {
      await resend.emails.send({
        from: MAIL_FROM,
        to: [email],
        subject: `Volunteer Application Received | BUE Foundation`,
        html: `
          <div style="font-family:Arial,sans-serif;max-width:600px;color:#212121;">
            <div style="background:#4B1F6F;padding:20px 24px;border-radius:8px 8px 0 0;">
              <h2 style="color:white;margin:0;">Volunteer Application Received</h2>
              <p style="color:rgba(255,255,255,0.75);margin:4px 0 0;">BUE Foundation</p>
            </div>
            <div style="background:#f7f7f7;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e8e8e8;border-top:none;">
              <p>Dear <strong>${name}</strong>,</p>
              <p>Thank you for applying to volunteer with the BUE Foundation as a <strong>${role}</strong>. We are delighted by your interest in joining our Joybringers community!</p>
              <p>Our volunteer coordinator will review your application and be in touch within <strong>5 business days</strong> to discuss the next steps.</p>
              <p>Visit us at <a href="https://buef.joybringerscharity.org" style="color:#4B1F6F;">buef.joybringerscharity.org</a> to learn more about how we serve communities.</p>
